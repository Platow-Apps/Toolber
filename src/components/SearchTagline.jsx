...
function TireIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="h-3.5 w-3.5 shrink-0" fill="none" stroke="#7C8087" strokeWidth="2" strokeLinecap="round">
...
function FlowerIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="h-3.5 w-3.5 shrink-0" fill="#3B7A3F">
...
function HammerIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="h-3.5 w-3.5 shrink-0" fill="none" stroke="#B5602A" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
function DrillIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="h-3.5 w-3.5 shrink-0" fill="none" stroke="#F2B90B" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
