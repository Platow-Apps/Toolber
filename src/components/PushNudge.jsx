  ...
  return (
    <>
      <div className="mb-3.5 flex items-center gap-2.5 rounded-lg border border-cardBorder bg-panel px-3 py-2.5">
        ...
        <p className="flex-1 text-[0.75rem] leading-snug text-steelLight">
          Get a ping when someone answers, instead of checking back.
        </p>
        <button
          type="button"
          onClick={() => setAsking(true)}
          className="flex-shrink-0 rounded-md bg-safety px-2.5 py-1.5 font-condensed text-[0.75rem] font-bold uppercase tracking-wide text-asphalt"
        >
          Turn on
        </button>
        <button
