...
const SELECT_COLUMNS =
  "id, name, category, description, status, monetize, price, price_duration_unit, for_sale, crib_id, photos, profiles(display_name, approx_lat, approx_lng, map_pin_hidden)";
