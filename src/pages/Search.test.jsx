...
test.serial("hides your own tools from the results when the profile says to", async (t) => {
  // Your own listings are the ones in the way on the screen where you are
  // looking for someone else's. The preference lives on the profile (0051),
  ...
  await render({
    ...
    profile: makeProfile({ show_own_tools: false }),
  });
