...
/* ---------------------------------------------------------
   ...
   NOTE: this is the ported MVP prototype, kept as the starting
   point per docs/technical-design.md's Migration Plan. It still
   uses SEED_TOOLS/GROUPS in-memory state — wiring to Supabase,
   the Motorsport visual direction, and the full screen set from
   the mockups happens incrementally from here. See CLAUDE.md.
--------------------------------------------------------- */
